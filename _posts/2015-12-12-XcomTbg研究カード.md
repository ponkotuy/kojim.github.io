...
|名前 | コスト | 効果 | 評価 |
|:--: | :----: | :--- | :--- |
|Defense Matrix      | 1 | RESOLUTION PHASE<br/>Exhaust<br/>戦闘機1機の破壊を回避 | 使用機会はなくはないだろうが、やや微妙か|
...
|名前 | コスト | 効果 | 評価 |
|:--: | :----: | :--- | :--- |
|Holo-Targeting      | 1 | RESOLUTION PHASE<br/>ヘビーを1人配置<br/>ミッションまたはエネミータスクのダイスロールの前に脅威を1減少させる(1以下にはならない)||
|Battle Scanners     | 1 | RESOLUTION PHASE<br/>スナイパーを1人配置<br/>|ミッションまたはエネミータスク1つのすべてのアイコンを専門化する|
|Run & Gun           | 1 | RESOLUTION PHASE<br/>アサルトを1人配置<br/>エネミータスク1つのXCOMダイスを1つ追加||
|Carapace Armor      | 1 | RESOLUTION PHASE<br/>Exhaust<br/>ミッションまたはエネミータスクでエイリアンダイスを振りなおす||
|Archangel Armor     | 1 | TIMED PHASE     <br/>兵士を1人配置<br/>エネミーデッキ上から宇宙人の死体を1つ獲得する。ラウンド中に2回まで使用可||
|Arc Thrower         | 1 | RESOLUTION PHASE<br/>Exhaust<br/>選択した敵1体の特殊能力をこのラウンド失わせる||
|Blaster Launcher    | 2 | RESOLUTION PHASE<br/>Exhaust<br/>ヘビーのアサインされた敵に成功トークンを1つ配置||
|Plasma Sniper       | 2 | RESOLUTION PHASE<br/>Exhaust<br/>スナイパーのアサインされた敵に成功トークンを1つ配置||
|Alloy Cannon        | 2 | RESOLUTION PHASE<br/>Exhaust<br/>アサルトのアサインされた敵に成功トークンを1つ配置||
|Light Plasma Rifle  | 2 | RESOLUTION PHASE<br/>Exhaust<br/>サポートのアサインされた敵に成功トークンを1つ配置||
|Revive              | 2 | RESOLUTION PHASE<br/>サポートを1人配置<br/>兵士1の死亡を回避||
